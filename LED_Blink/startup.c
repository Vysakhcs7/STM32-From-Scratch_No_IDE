...
// Define SRAM and stack properties
#define SRAM_START 0x20000000
#define SRAM_SIZE  (128U * 1024U)  // 128KB
#define SRAM_END   ((SRAM_START) + (SRAM_SIZE))
#define STACK_START SRAM_END

// External symbols for sections defined in the linker script
...
// Function prototypes for exception and interrupt handlers
...
// External interrupt handlers with weak aliases
...
// Vector table with all handlers
__attribute__((section(".isr_vector"))) uint32_t Vectors[] = {
    ...
    (uint32_t)&DebugMon_Handler,     // DebugMonitor handler
